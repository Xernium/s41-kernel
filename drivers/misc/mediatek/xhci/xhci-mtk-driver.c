...
void cei_enable_normal_otg_mode(void)
{
	int ret = 999;

	pr_err("%s: CEI Enable normal otg mode.\n", __func__);

	charger_dev_enable_otg(primary_charger, true);
	charger_dev_enable_cfo(primary_charger, false);
...
void cei_enable_otg_mode(void)
{
	int ret = 999;

	pr_err("%s: CEI Enable otg mode.\n", __func__);

	charger_dev_enable_otg(primary_charger, true);
	charger_dev_set_usbsw(primary_charger, RT5081_USBSW_CHG);
	charger_dev_short_dpdm(primary_charger, 1);
...
void cei_disable_otg_mode(void)
{
	int ret = 999;

	pr_err("%s: CEI disable otg mode.\n", __func__);

	charger_dev_set_usbsw(primary_charger, RT5081_USBSW_USB);
	charger_dev_short_dpdm(primary_charger, 0);
...
#endif
	 */
	pr_err("%s: Enable otg mode.\n", __func__);
	charger_dev_set_mivr(primary_charger, 9000000);
	charger_dev_enable_cfo(primary_charger, false);
	charger_dev_enable(primary_charger, false);
	charger_dev_set_stop_charg(primary_charger, true);
	pr_err("==================================\n");
	charger_dev_dump_registers(primary_charger);
	pr_err("==================================\n");
}

static void mtk_disable_otg_mode(void)
{
	pr_err("%s: disable otg mode.\n", __func__);
	charger_dev_set_mivr(primary_charger, 4400000);
	charger_dev_set_stop_charg(primary_charger, false);
	charger_dev_enable_cfo(primary_charger, true);
