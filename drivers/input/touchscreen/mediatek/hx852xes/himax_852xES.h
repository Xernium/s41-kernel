...
#define HIMAX_PROC_FWVERSION_FOR_I_FILE "fw_version_for_i"
static struct proc_dir_entry *himax_proc_fwversion_for_i_file = NULL;
#endif
...
/* CT41 add fw_check node */
#define HX_TP_FW_CHECK
#ifdef HX_TP_FW_CHECK
#define HIMAX_PROC_FW_CHECK_FILE "fw_check"
static struct proc_dir_entry *himax_proc_fw_check_file = NULL;

#define DEFAULT_FW_VER_H 0x19
...
/* CT41 add sensor id node */
#define HX_TP_SENSOR_ID
#ifdef HX_TP_SENSOR_ID
#define HIMAX_PROC_SENSOR_ID_FILE "sensor_id"
static struct proc_dir_entry *himax_proc_sensor_id_file = NULL;

#define SENSOR_ID_FLOATING 1
#define SENSOR_ID_GROUND 2
#define SENSOR_ID_VCC 4
#endif
...
#define OFILM_SENSOR_ID 0x11
#define ELLY_SENSOR_ID 0x12
#endif

#ifdef HX_SMART_WAKEUP
#define SMART_WAKEUP_FLAG 0x80

#define HX_SMART_WAKEUP_REG 0x8F
#define ENABLE_SMART_WAKEUP_MODE 0x20
#define DISABLE_SMART_WAKEUP_MODE 0x00
#endif

/* CCI Dean add, CT41 */
#define HX_TP_GLOVE_MODE	/* add glove mode */
/* for BUG 1147, To prevent false touch when Call on */
#define PS_DISABLE_CALLPHONE_BUTTON_UI

#ifdef PS_DISABLE_CALLPHONE_BUTTON_UI
/* #define PS_DISABLE_SPECIFIC_AREA */
#endif

#define PHONE_CALLING_STATUS	/* add monitor Calling status node */

/* add glove mode node */
#ifdef HX_TP_GLOVE_MODE
#define HIMAX_PROC_GLOVE_MODE_FILE "glove_mode"
static struct proc_dir_entry *himax_proc_glove_mode_file = NULL;

#define HIMAX_PROC_GLOVE_ON_FILE "glove_on"
static struct proc_dir_entry *himax_proc_glove_on_file = NULL;

#define HIMAX_PROC_GLOVE_OFF_FILE "glove_off"
static struct proc_dir_entry *himax_proc_glove_off_file = NULL;

uint8_t glove_state;
#define HX_GLOVE_REG 0x8F	/* Smart Wakeup Reg. is the same */
#define ENABLE_GLOVE_MODE 0x80
#define DISABLE_GLOVE_MODE 0x00
#endif

/* for BUG 1147, to prevent false touch when Calling */
#ifdef PS_DISABLE_CALLPHONE_BUTTON_UI

#ifdef PS_DISABLE_SPECIFIC_AREA

#define STATUS_BAR_AXIS_Y 80
#define CALL_PHONE_UI_RANGE_X_MIN 250
#define CALL_PHONE_UI_RANGE_Y_MIN 500
#define CALL_PHONE_UI_RANGE_X_MAX 780
#define CALL_PHONE_UI_RANGE_Y_MAX 680

#else

#define STATUS_BAR_AXIS_Y 680

#endif
#endif

/* add Calling status node */
#ifdef PHONE_CALLING_STATUS
#define PHONE_CALL_ON true
#define PHONE_CALL_OFF false
static bool phone_calling_status = PHONE_CALL_OFF;

#define HIMAX_PROC_CALLING_STATUS_FILE "calling_status"
static struct proc_dir_entry *himax_proc_calling_status_file;

#define HIMAX_PROC_PHONE_CALL_ON_FILE "phone_call_on"
static struct proc_dir_entry *himax_proc_phone_call_on_file;

#define HIMAX_PROC_PHONE_CALL_OFF_FILE "phone_call_off"
static struct proc_dir_entry *himax_proc_phone_call_off_file;
#endif

#ifdef HX_ESD_WORKAROUND
#define HIMAX_PROC_ESD_RECOVERY_COUNT_FILE "ESD_count"
static struct proc_dir_entry *himax_proc_ESD_recovery_count_file = NULL;

#define HIMAX_PROC_ESD_OFF_FILE "ESD_off"
static struct proc_dir_entry *himax_proc_ESD_off_file = NULL;
#endif
...
static struct proc_dir_entry *himax_proc_reset_file 		= NULL;
	...
	#define HIMAX_PROC_CCI_SELF_TEST_FILE	"cci_self_test"
	static struct proc_dir_entry *himax_proc_cci_self_test_file = NULL;
#endif
...
//static int gest_width=0,gest_height=0,gest_mid_x=0,gest_mid_y=0;
	...
	#define HIMAX_PROC_SMWP_ON_FILE "SMWP_on"
	static struct proc_dir_entry *himax_proc_SMWP_on_file = NULL;
	#define HIMAX_PROC_SMWP_OFF_FILE "SMWP_off"
	static struct proc_dir_entry *himax_proc_SMWP_off_file = NULL;
#endif
...
static int hx_panel_coords[4] = {0,1080,0,1920};
